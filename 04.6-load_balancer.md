...
_Exam Tips_:
- 504 Error -- gateway timeoutd out --> aplication is not responding within the idle timeout period.
- If you need the IPv4 of the client, look for the **X-Forwarded-For** header.
- Instances monitored by ELB are reported as InService or OutOfService
- Healt Check check the instance health by talking to it
- Have their own DNS name (you can't get an IP address)
